...
/**
 ...
 the number of seconds since midnight on 1st January 1970. It is totally independent
...
public struct Instant {
    ...
    public let millisecondsSinceReferenceDate: Double
    ...
    public init(_ secondsSinceReferenceDate: Double) {
        ...
        self.millisecondsSinceReferenceDate = secondsSinceReferenceDate*1000
    }
    ...
    public init(millisSinceReferenceDate: Double) {
        ...
        self.millisecondsSinceReferenceDate = millisSinceReferenceDate
    }
    ...
    public func asNSDate() -> Date {
        return Date(timeIntervalSince1970: self.secondsSinceReferenceDate)
    }
