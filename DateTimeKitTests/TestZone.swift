...
//		XCTAssertTrue(Zone(TimeZone(identifier: "GMT")!) == Zone.gmt())
//		XCTAssertTrue(Zone(TimeZone(secondsFromGMT: 0)) == Zone.gmt())
//	}
//	
//	func testParseZone() {
...
//		let z1 = Zone("+16:10")!
//		XCTAssertEqual(z1.displayName(Locale(localeIdentifier: "en_AU")), "GMT+16:10")
//		XCTAssertEqual(z1.displayName(Locale(localeIdentifier: "fr_FR")), "UTC+16:10")
//		let z2 = Zone("+10:00")!
//		XCTAssertEqual(z2.displayName(Locale(localeIdentifier: "en_AU")), "GMT+10:00")
//		XCTAssertEqual(z2.displayName(Locale(localeIdentifier: "fr_FR")), "UTC+10:00")
//		let z3 = Zone(TimeZone(identifier: "Australia/Sydney")!)
//		XCTAssertEqual(z3.displayName(Locale(localeIdentifier: "en_AU")), "Australian Eastern Standard Time")
//		XCTAssertEqual(z3.displayName(Locale(localeIdentifier: "fr_FR")), "heure normale de l’Est de l’Australie")
//		let z4 = Zone.gmt()
//		XCTAssertEqual(z4.displayName(Locale(localeIdentifier: "en_AU")), "GMT")
//		XCTAssertEqual(z4.displayName(Locale(localeIdentifier: "fr_FR")), "UTC")
//		let z5 = Zone.utc()
//		XCTAssertEqual(z5.displayName(Locale(localeIdentifier: "en_AU")), "GMT")
//		XCTAssertEqual(z5.displayName(Locale(localeIdentifier: "fr_FR")), "UTC")
//	}
